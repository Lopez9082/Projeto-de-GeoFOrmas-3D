...
<div class="login-card">
  ...
  <form method="post" action="<?= site_url('professor/registrar') ?>">
    ...
    <input type="faculdade" name="faculdade" required>
  ...
  <a class="link-small" href="<?= site_url('professor/login') ?>">← Já tenho conta</a>
</div>
