...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url('assets/css/mathgame-theme/acessibilidade.css') ?>">

  <script src="<?= base_url('assets/js/acessibilidade.js') ?>" defer></script>
</head>
<body>
...
<section class="section" id="sobre">
  ...
  <div class="sobre-grid">
    ...
    <div class="sobre-card fade-up">
      ...
      <p>Esta pesquisa é proposta e conduzida sob a responsabilidade da <strong style="color:var(--neon-cyan)">Universidade Iguaçu — UNIG</strong>, por meio do <strong style="color:var(--neon-cyan)">Núcleo de Educação a Distância — NEAD</strong>.</p>
      <p>Ambos os órgãos respondem institucionalmente pela orientação científica, pedagógica e técnica do Programa de Iniciação Científica ao qual o MathGame está vinculado.</p>
    </div>
...
<footer class="site-footer">
  ...
  <p style="margin-top:14px;opacity:.85;max-width:560px;margin-left:auto;margin-right:auto">
    Proposta de pesquisa sob responsabilidade institucional da <strong>Universidade Iguaçu — UNIG</strong>
    e do <strong>Núcleo de Educação a Distância — NEAD</strong>.
  </p>
</footer>
